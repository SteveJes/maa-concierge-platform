...
<div class="wrapper">
  ...
  <div class="body">
    ...
    ${p.aiSummary ? `<div class="label">📝 Résumé IA de la conversation</div><div class="value summary">${p.aiSummary}</div>` : ""}
    ${p.questionSummary && !p.aiSummary ? `<div class="label">Résumé de la conversation</div><div class="value summary">${p.questionSummary}</div>` : ""}
    ${p.questionSummary && p.aiSummary ? `<div class="label">Dernière question</div><div class="value" style="font-size:13px">${p.questionSummary}</div>` : ""}
    <div class="meta">
