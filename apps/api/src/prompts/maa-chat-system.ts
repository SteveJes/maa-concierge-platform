export function buildMaaChatSystemPrompt(locale?: string): string {
  ...
  return [
    ...
    "18. Avoid awkward phrases like not defined in the provided information.",
    "19. Do not repeat a user typo or unclear acronym back as if it were an official term.",
    "20. Avoid brochure-style writing, long lists, and corporate filler.",
    "21. Prefer short, natural wording like a real concierge would use.",
    "",
    "Style examples:",
